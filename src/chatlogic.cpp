                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            auto parentNode = std::find_if(_nodes.begin(), _nodes.end(), [&parentToken](const std::unique_ptr<GraphNode> &node) { return node->GetID() == std::stoi(parentToken->second); }); //const std::unique_ptr<GraphNode> &node
                            ...
                            edge->SetChildNode(childNode->get()); //- >get());
                            edge->SetParentNode(parentNode->get()); //- f>g et());
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge));    // std::move
                        }
